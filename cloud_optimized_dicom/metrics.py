...
# What `Instance.compress` did with pixel data that arrived compressed, keyed
# by `TranscodeOutcome.value`; bytes saved counts the file-size drop of the
# re-encoded instances.
